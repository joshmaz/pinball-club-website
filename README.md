...
- `assets/js/site-account.js` - progressive public-site account menu with dashboard and sign-out actions
- `assets/js/member-routes.js` - validated Member Tools panel/item routes, including direct game and event editor links
