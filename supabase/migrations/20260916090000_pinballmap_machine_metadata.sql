-- Fill missing catalog identifiers from Pinball Map's authenticated machine-details feed.
-- Existing nonblank values are intentionally preserved so member edits remain authoritative.
