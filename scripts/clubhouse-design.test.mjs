...
test('all nine main routes share the theme selector without changing other pages', async () => {
  for (const page of ['index.html','events.html','games.html','members.html','resources.html','merch.html','about.html','signin.html','donate/index.html']) {
  ...
  assert.match(await read('donate.html'), /http-equiv="refresh"/);
});
